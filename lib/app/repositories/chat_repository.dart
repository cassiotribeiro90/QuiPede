...
class ChatRepository extends BaseRepository {
  ...
  /// Inicia um chat genérico com a loja (sem pedido)
  Future<Map<String, dynamic>> iniciarChatGenerico({
    required int lojaId,
    String? mensagemInicial,
  }) async {
    try {
      final response = await dio.post(
        '/api/app/chats/generico',
        data: {
          'loja_id': lojaId,
      ...
      throw Exception(response.data['message'] ?? 'Erro ao iniciar chat genérico');
    } catch (e) {
      throw handleError(e);
    }
  }
