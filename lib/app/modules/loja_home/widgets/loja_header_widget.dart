...
class LojaHeaderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // ================================================================
        // 🔥 CAPA DA LOJA COM SOBREPOSIÇÃO DO BOTÃO CHAT
        // ================================================================
        Stack(
          ...
          children: [
            ...
            // 🔥 BOTÃO DE CHAT SOBREPOSTO NA CAPA
            Positioned(
              top: 12,
              right: 12,
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              // ================================================================
              // 🔥 LINHA 1: NOME + STATUS + CHAT (TEXTO)
              // ================================================================
              Row(
                children: [
                  Expanded(
  ...
  Widget _buildChatButton(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        onTap: () => _abrirChatGenerico(context),
        borderRadius: BorderRadius.circular(12),
        child: Container(
  ...
  void _abrirChatGenerico(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ChatScreen(
          lojaId: loja.id,
          mensagemInicial: 'Olá! Gostaria de tirar uma dúvida sobre a ${loja.nome}.',
        ),
      ),
    );
  }
